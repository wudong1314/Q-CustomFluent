...
struct QCusFluentFramelessDelegate_win::Impl
{
...
QCusFluentFramelessDelegate_win::QCusFluentFramelessDelegate_win(QWidget* parent, const QWidgetList& moveBars)
...
QCusFluentFramelessDelegate_win::QCusFluentFramelessDelegate_win(QWidget* parent, QWidget* title)
    : QCusFluentFramelessDelegate_win(parent, QWidgetList { title })
{
}

QCusFluentFramelessDelegate_win::~QCusFluentFramelessDelegate_win() {}

void QCusFluentFramelessDelegate_win::addMoveBar(QWidget* w)
{
    if (!isCompositionEnabled() && qobject_cast<QCusFluentTitleBar*>(w)) // for win7 解决出现默认关闭按钮等问题.
    {
        w->winId();
    }
...
void QCusFluentFramelessDelegate_win::removeMoveBar(QWidget* w) { m_impl->moveBars.removeOne(w); }
...
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
bool QCusFluentFramelessDelegate_win::nativeEvent([[maybe_unused]] const QByteArray& eventType, void* message, long* result)
#else
bool QCusFluentWinFramelessDelegate::nativeEvent(const QByteArray& eventType, void* message, qintptr* result)
#endif
{
...
bool QCusFluentFramelessDelegate_win::eventFilter(QObject* watched, QEvent* event)
{
...
void QCusFluentFramelessDelegate_win::setWindowLong()
{
...
void QCusFluentFramelessDelegate_win::showSystemMenu(const QPoint& pos)
{
...
#if QT_VERSION < QT_VERSION_CHECK(6, 0, 0)
bool QCusFluentFramelessDelegate_win::onNCTitTest(MSG* msg, long* result)
#else
bool QCusFluentWinFramelessDelegate::onNCTitTest(MSG* msg, qintptr* result)
#endif
{
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    ...
    for (auto w : m_impl->moveBars)
    {
        ...
        if (child == w)
        {
            ...
            auto title = qobject_cast<QCusFluentTitleBar*>(w);
            if (title)
            {
