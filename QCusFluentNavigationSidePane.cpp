...
struct QCusFluentNavigationSidePane::Impl
{
    DockArea dockArea{ DockArea::Left };
    QAction* bindAction{ nullptr };
    QCusFluentNavigationBar* navigationBar{ nullptr };
...
/*!
    ...
    \ingroup    QCustomUi
    \inmodule   QCustomUi
    \inheaderfile QCusFluentNavigationSidePane.h

    \b          {截图:}
    \image      QCusFluentNavigationPaneDetail.png
*/

/*!
    \enum       QCusFluentNavigationSidePane::DockArea
                停靠位置.
    \value      Left
                窗口左侧.
    \value      Top
...
/*!
    \fn         QCusFluentNavigationSidePane::paneClosed()
    \brief      停靠窗口关闭时发送该信号.
*/
...
/*!
    \brief      构造函数 \a parent.
*/
QCusFluentNavigationSidePane::QCusFluentNavigationSidePane(QCusFluentNavigationBar* parent) : QWidget(parent), m_impl(std::make_unique<Impl>())
{
...
*/
QCusFluentNavigationSidePane::QCusFluentNavigationSidePane(DockArea area, QCusFluentNavigationBar* parent) : QCusFluentNavigationSidePane(parent)
{
    setDockArea(area);
}
...
/*!
    \brief      析构函数.
*/
QCusFluentNavigationSidePane::~QCusFluentNavigationSidePane() {}

/*!
    \brief      设置窗口停靠位置 \a area.
    \sa         dockArea
*/
void QCusFluentNavigationSidePane::setDockArea(DockArea area)
{
...
/*!
    ...
    \sa         setDockArea
*/
QCusFluentNavigationSidePane::DockArea QCusFluentNavigationSidePane::dockArea() const { return m_impl->dockArea; }
...
/*!
    ...
    \sa         widget()
*/
void QCusFluentNavigationSidePane::setWidget(QWidget* widget) { m_impl->area->setWidget(widget); }

/*!
    \brief      返回设置的窗口.
    \sa         setWidget
*/
QWidget* QCusFluentNavigationSidePane::widget() const { return m_impl->area->widget(); }

/*!
    \brief      返回容器窗口.
    \sa         widget()
*/
QScrollArea* QCusFluentNavigationSidePane::viewContainer() const { return m_impl->area; }

/*!
    \brief      设置标题栏是否可见 \a visible.
    \sa         titleBarIsVisible()
*/
void QCusFluentNavigationSidePane::setTitleBarVisible(bool visible) { m_impl->titleBar->setVisible(visible); }

/*!
    \brief      返回标题栏是否可见.
    \sa         setTitleBarVisible
*/
bool QCusFluentNavigationSidePane::titleBarIsVisible() const { return m_impl->titleBar->isVisible(); }

/*!
    \brief      设置标题栏文字 \a text.
    \sa         title()
*/
void QCusFluentNavigationSidePane::setTitle(const QString& text) { m_impl->title->setText(text); }

/*!
    \brief      返回标题栏文字.
    \sa         setTitle
*/
QString QCusFluentNavigationSidePane::title() const { return m_impl->title->text(); }

/*!
    \brief      设置窗口是否以Popup方式显示 \a popup.
    \sa         popup()
*/
void QCusFluentNavigationSidePane::setPopup(bool popup)
{
    m_impl->popup = popup;
...
/*!
    ...
    \sa         setPopup
*/
bool QCusFluentNavigationSidePane::popup() const { return m_impl->popup; }

/*!
    \reimp
*/
void QCusFluentNavigationSidePane::paintEvent([[maybe_unused]] QPaintEvent* event) { paintShadow(margin); }

/*!
    \reimp
*/
void QCusFluentNavigationSidePane::showEvent([[maybe_unused]] QShowEvent* event)
{
...
/*!
    \reimp
*/
void QCusFluentNavigationSidePane::closeEvent([[maybe_unused]] QCloseEvent* event) { emit paneClosed(); }

/*!
    \reimp
*/
QSize QCusFluentNavigationSidePane::sizeHint() const
{
    if (!m_impl->navigationBar)
...
/*!
    ...
    \sa         smartPosition
*/
QSize QCusFluentNavigationSidePane::smartSize(DockArea area) const
{
...
/*!
    \brief      绑定 QCusFluentNavigationBar \a bar.
    \sa         navigationBar(), QCusFluentNavigationBar
*/
void QCusFluentNavigationSidePane::setNavigationBar(QCusFluentNavigationBar* bar)
{
    if (m_impl->navigationBar)
    {
...
/*!
    \brief      返回绑定的 QCusFluentNavigationBar.
    \sa         setNavigationBar, QCusFluentNavigationBar
*/
QCusFluentNavigationBar* QCusFluentNavigationSidePane::navigationBar() const { return m_impl->navigationBar; }

/*!
    \reimp
*/
bool QCusFluentNavigationSidePane::eventFilter(QObject* o, QEvent* e)
{
...
/*!
    \reimp
*/
void QCusFluentNavigationSidePane::mousePressEvent(QMouseEvent* event)
{
    event->ignore();
...
/*!
    \brief      绑定到 QCusFluentNavigationBar 上的 \a action.
    \sa         QCusFluentNavigationBar
*/
void QCusFluentNavigationSidePane::bindAction(QAction* action) { m_impl->bindAction = action; }

/*!
    \brief      绘制阴影 \a shadowWidth.
    \sa         paintEvent
*/
void QCusFluentNavigationSidePane::paintShadow(int shadowWidth)
{
...
/*!
    ...
    \sa         smartSize
*/
QPoint QCusFluentNavigationSidePane::smartPosition(DockArea area) const
{
    if (!m_impl->navigationBar)
        return QPoint(0, 0);
    auto topWidget = m_impl->navigationBar->window();
