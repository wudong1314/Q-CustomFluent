...
struct QCusFluentMessageViewDelegate::Impl
{
...
QCusFluentMessageViewDelegate::QCusFluentMessageViewDelegate(QObject* parent) : QStyledItemDelegate(parent), m_impl(std::make_unique<Impl>()) {}

QCusFluentMessageViewDelegate::~QCusFluentMessageViewDelegate() {}

void QCusFluentMessageViewDelegate::paint(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    auto opt = option;
...
QSize QCusFluentMessageViewDelegate::sizeHint(const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    ...
    const auto& title = model->data(model->index(index.row(), QCusFluentMessageTipData::Title), Qt::DisplayRole).toString();
    const auto& time = model->data(model->index(index.row(), QCusFluentMessageTipData::Time), Qt::DisplayRole).toString();
...
void QCusFluentMessageViewDelegate::setDecoration(const QColor& color) { m_impl->decoration = color; }

const QColor& QCusFluentMessageViewDelegate::decoration() const { return m_impl->decoration; }

void QCusFluentMessageViewDelegate::setCloseButtonIcon(const QPixmap& pixmap) { m_impl->closeButtonIcon = pixmap; }

const QPixmap& QCusFluentMessageViewDelegate::closeButtonIcon() const { return m_impl->closeButtonIcon; }

void QCusFluentMessageViewDelegate::setTouchControlStyle(bool flag) { m_impl->touchControlStyle = flag; }

bool QCusFluentMessageViewDelegate::touchControlStyle() const { return m_impl->touchControlStyle; }

void QCusFluentMessageViewDelegate::drawTitle(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    auto model = index.model();
    const auto& title = model->data(model->index(index.row(), QCusFluentMessageTipData::Title), Qt::DisplayRole).toString();
    ...
    painter->setPen(model->data(model->index(index.row(), QCusFluentMessageTipData::Title), Qt::ForegroundRole).value<QColor>());
    painter->drawText(doTitleRect(option, index), title, to);
    painter->restore();
}

void QCusFluentMessageViewDelegate::drawDateTime(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    auto model = index.model();
    const auto& time = model->data(model->index(index.row(), QCusFluentMessageTipData::Time), Qt::DisplayRole).toString();
    ...
    painter->save();
    painter->setPen(model->data(model->index(index.row(), QCusFluentMessageTipData::Time), Qt::ForegroundRole).value<QColor>());
    painter->drawText(doDateTimeRect(option, index), time, to);
    painter->restore();
}

void QCusFluentMessageViewDelegate::drawCloseButton(QPainter* painter,
...
void QCusFluentMessageViewDelegate::drawDecoration(QPainter* painter,
...
void QCusFluentMessageViewDelegate::drawBackground(QPainter* painter,
    const QStyleOptionViewItem& option,
    [[maybe_unused]] const QModelIndex& index) const
{
...
QRect QCusFluentMessageViewDelegate::doDateTimeRect(const QStyleOptionViewItem& option, const QModelIndex& index) const
{
...
QRect QCusFluentMessageViewDelegate::doTitleRect(const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    const auto& title = index.model()->data(index.model()->index(index.row(), QCusFluentMessageTipData::Title), Qt::DisplayRole).toString();
...
QRect QCusFluentMessageViewDelegate::doCloseBtnRect(const QStyleOptionViewItem& option) const
{
...
bool QCusFluentMessageViewDelegate::editorEvent(QEvent* event,
