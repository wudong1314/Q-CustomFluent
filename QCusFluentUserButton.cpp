...
struct QCusFluentUserButton::Impl
{
};

QCusFluentUserButton::QCusFluentUserButton(QWidget* parent) : QCusFluentToolButton(parent), m_impl(std::make_unique<Impl>()) {}

QCusFluentUserButton::~QCusFluentUserButton() {}

void QCusFluentUserButton::paintEvent(QPaintEvent*)
{
    QPainter p(this);
...
QSize QCusFluentUserButton::sizeHint() const
{
    QStyleOptionToolButton opt;
    initStyleOption(&opt);
...
QSize QCusFluentUserButton::minimumSizeHint() const { return sizeHint(); }

QRect QCusFluentUserButton::doTextRect(const QStyleOptionToolButton& opt) const
{
    const auto& rect    = this->style()->subElementRect(QStyle::SE_FrameContents, &opt, this);
...
QRect QCusFluentUserButton::doIconRect(const QStyleOptionToolButton& opt) const
{
    const auto& rect = this->style()->subElementRect(QStyle::SE_FrameContents, &opt, this);
